...
export const TERMINAL_TONE: Record<string, SignalTone> = {
  ...
  // vet_network
  propose_appointments: "go",
  request_owner_input: "ping",
  escalate_no_coverage: "stop",
  // airline_crate
  propose_flight: "go",
  flag_embargo: "stop",
  // endorsement
  submit_endorsement: "go",
  schedule_endorsement: "hold",
  block_endorsement: "stop",
  // audit
  emit_findings: "amber",
};
...
export const AGENT_META: Record<string, { label: string; color: string; short: string }> = {
  ...
  audit:               { label: "Audit",                color: "#8b95a6", short: "WCH" },

...
export const TERMINAL_TONE: Record<string, SignalTone> = {
  ...
  propose_dates: "amber",
  book_appointment: "go",
  no_vet_available: "stop",
  propose_route: "amber",
  book_flight: "go",
  no_feasible_route: "stop",
  schedule_endorsement: "amber",
  submit_to_authority: "go",
  window_infeasible: "stop",
  flag_finding: "ping",
  all_clear: "go",
};
...
export const AGENT_META: Record<string, { label: string; color: string; short: string }> = {
  ...
  endorsement:         { label: "Endorsement Team",     color: "#60a5fa", short: "END" },

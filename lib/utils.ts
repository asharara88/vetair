...
export const TERMINAL_TONE: Record<string, SignalTone> = {
  ...
  book_appointment: "go",
  no_vets_available: "stop",
  select_route: "go",
  flag_embargo: "stop",
  flag_breed_carrier_restriction: "stop",
  submit_endorsement: "go",
  flag_window_conflict: "stop",
  request_health_certificate: "ping",
  flag_finding: "ping",
  clear_audit: "go",
};
...
export const AGENT_META: Record<string, { label: string; color: string; short: string }> = {
  ...
  audit:               { label: "Audit Watchdog",       color: "#8b95a6", short: "AUW" },

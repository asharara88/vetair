...
export const TERMINAL_TONE: Record<string, SignalTone> = {
  ...
  // Vet Network
  propose_appointment: "go",
  no_match: "stop",
  // Endorsement
  submit_to_authority: "amber",
  record_endorsement: "go",
  fail_endorsement: "stop",
  // Airline
  recommend_crate: "go",
  book_cargo_slot: "go",
  blocked_by_breed: "stop",
};
...
export const AGENT_META: Record<string, { label: string; color: string; short: string }> = {
  ...
  endorsement:         { label: "Endorsement Desk",     color: "#60a5fa", short: "END" },
  airline:             { label: "Airline & Crate",      color: "#60a5fa", short: "AIR" },

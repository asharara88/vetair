...
import { DOCUMENT_KINDS, requestDocumentTool } from "./shared-tools";
...
const SPECIALIST_DOCUMENT_KINDS = [...DOCUMENT_KINDS, "confirm_destination"] as const;

const TEMPLATE_TOOLS: AgentTool[] = [
  ...COMPLIANCE_SHARED_READ_TOOLS,
  COMPLIANCE_ASSESSMENT_TOOL,
  requestDocumentTool({ kinds: SPECIALIST_DOCUMENT_KINDS }),
];

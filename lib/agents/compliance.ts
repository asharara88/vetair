...
// Tool shapes shared with the Auditor and synthesized Specialists. Exposed via
// named exports so dependents don't reach into module internals.
...
export const COMPLIANCE_SHARED_READ_TOOLS: readonly AgentTool[] = [
  {

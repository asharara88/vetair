...
export const AGENT_TYPE_BLURB: Record<AgentType, string> = {
  ...
  vet_network:
    "Matches the owner to an approved vet, books pre-flight procedures, and proposes candidate dates into the consensus loop.",
  airline_crate:
    "Applies IATA LAR + CR-82 crate sizing, picks a route around temperature embargoes, and proposes a feasible flight.",
  endorsement:
    "Pins the pre-flight endorsement window, submits to MOCCAE/APHA, and tracks the courier until the endorsed cert is delivered.",
  comms:

...
export const ORCHESTRATOR: AgentDefinition = validateAgent({
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Terminal: enqueue a task targeting another active agent.",
      input_schema: {
        type: "object",
        properties: {
    ...
    },
    {
      ...
      description: "Terminal: route the case to the human break-glass queue. Use when budget is exhausted or the auditor has dissented twice.",
      input_schema: {
        type: "object",
        properties: {
          case_id: { type: "string" },
